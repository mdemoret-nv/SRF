...
//                                                                     << " one or more subscribe_to_roles were
//                                                                     invalid"));
//     }
...
// Expected<Server::instance_t> Server::validate_instance_id(const instance_id_t& instance_id, const event_t& event)
// const
// {
...
//         {
//             return Error::create(MRC_CONCAT_STR(
//                 "instance_id (" << instance_id << ") not assocated with machine/stream: " <<
//                 event.stream->get_id()));
//         }
//         return i;
//     });
